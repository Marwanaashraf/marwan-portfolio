...
export let JQueryIcon = () => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M137.6 217.2c-13.6 38.4-7.6 82.2 16.4 118.6 24.2 36.8 62.8 63.8 108.2 74.6 45.8 10.8 93.4 3.2 131.6-21.2-34.2 29-80 44.2-126.6 41.6-46.4-2.8-90-23.8-121.2-58.2-31.2-34.6-48.6-80.6-48.6-127.8 0-34.6 9.6-68.2 27.8-97.4zM229.2 128c-10.8 30.6-6.2 64.6 12.6 93.4 18.6 29 48.4 50.4 83.6 59 35.2 8.6 72 2.2 101.6-17.4-26.6 22.6-62.4 33.8-98.2 31.6-35.8-2.2-69.2-18.2-93.2-44.6-24-26.2-37.4-61.6-37.4-98 0-26.4 7.4-52 21-74zM314.4 48c-8.4 23.8-4.8 50.4 9.8 72.6 14.6 22.2 38 38.6 65.4 45.2 27.6 6.6 56.4 1.8 79.6-13-20.8 17.6-48.8 26.4-76.6 24.8-27.8-1.8-53.8-14.2-72.4-34.6-18.6-20.6-28.8-48.4-28.8-76.8 0-20.8 5.8-40.8 16-58.2z"
      />
    </svg>
  );
};
export let ReduxIcon = () => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export let FramerIcon = () => {
  return (
    ...
    >
      <path d="M5 16L12 8L19 16H5Z" fill="currentColor"></path>
      <path
        d="M5 16L12 12L19 16V20H5V16Z"
        fill="currentColor"
        opacity="0.7"
      ></path>
    </svg>

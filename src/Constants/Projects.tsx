...
export const projectsList = [
  ...
  {
    name: "Education Lms",
    desc: "Developed a learning platform with secure authentication reducing unauthorized access attempts, Built an Admin Dashboard to manage courses, exams, and users — including adding, editing, and deleting content in real time ,displayed free and paid courses",
    srcCode: "https://github.com/Marwanaashraf/LMS",

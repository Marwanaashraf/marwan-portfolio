...
export default function About() {
  ...
  return (
    <section aria-label="About section" className="my-20 contain">
      {/* header */}
      <motion.h2
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3  xl:grid-cols-3 2xl:grid-cols-4 my-10 items-center gap-8 overflow-hidden">
        ...
        >
          <p className="dark:text-gray-400 text-base sm:text-lg leading-relaxed break-words">
            I am a <span className="text-main">Front-end Developer</span> with a
            strong passion for building web applications that are both
            interactive and user-friendly. I enjoy translating complex ideas
            into clean, efficient, and maintainable code, creating seamless
            experiences for users.
          </p>
          <p className="dark:text-gray-400 text-base sm:text-lg leading-relaxed break-words my-4">
            I specialize in modern front-end technologies like{" "}
            <span className="text-main">
              React.js, Next.js, and Tailwind CSS,
            </span>{" "}
            focusing on combining innovative design with performant, responsive
            interfaces to deliver high-quality web applications.
          </p>
        </motion.div>
      </div>
